...
export function RegionDetail({ region }: RegionDetailProps) {
  ...
  const energyFlow = useMemo(() => {
    ...
    const outgoing = 0; // TODO: Will be populated when API starts returning OUTGOING meter_type
    const boundaryNet =
        boundaryMetrics.totalImport - boundaryMetrics.totalExport;
    const availableSupply = bspImport + outgoing + boundaryNet;
    const dtxConsumption = dtxMetrics.consumption;
    const expressFeederExport = 0; // TODO: Will be populated when API starts returning Express Feeder Export data
  ...
  }, [bspMetrics, boundaryMetrics, dtxMetrics]);
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  {/* OUTGOING Section */}
                  <div className="relative">
                    <div className="p-4 bg-purple-500/20 rounded-lg border-2 border-purple-500 text-center">
                      <div className="flex items-center justify-center gap-2">
                        <div className="text-xs font-medium text-muted-foreground">
                          Express Feeder Import
                        </div>
                      </div>
                      <div className="text-lg font-bold mt-1">
                        {formatNumber(energyFlow.outgoing)}
                      </div>
                      <div className="text-xs text-muted-foreground">kWh</div>
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="relative">
                    ...
                    <div
                        ...
                        style={{ transform: "translateY(-50%)" }}
                    />
                    <div className="p-4 bg-teal-500/20 rounded-lg border-2 border-teal-500 text-center">
                      <div className="text-xs font-medium text-muted-foreground">
                        Express Feeder Export
                      </div>
                      <div className="text-lg font-bold mt-1">
                        {formatNumber(energyFlow.expressFeederExport)}
                      </div>
                      <div className="text-xs text-muted-foreground">kWh</div>
                      <div className="text-xs text-muted-foreground mt-1 italic">
                        Coming soon
