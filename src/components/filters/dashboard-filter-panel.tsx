...
export function DashboardFilterPanel({
  ...
  console.log("[v0] activeTab:", activeTab)
  console.log("[v0] locationOptions being used:", locationOptions.length, "items")
  console.log("[v0] boundaryPointOptions being used:", boundaryPointOptions.length, "items")
